...
```{r translation}
imgarray_trans <- translation(imgarray2,
                              shift = c(100,20))
```
...
```{r scale}
imgarray_scale <- scale(imgarray2, 
...
imgarray_affine <- affine(imgarray2, 
                          m = m,
                          filter = "bilinear")
```
...
imgarray_affine <- affine(imgarray2, 
                          m = m, 
                          filter = "bilinear")
imgarray_scale <- scale(imgarray_affine, 
                        output.dim = c(200,300),
                        filter = "bilinear")
imgarray_trans <- translation(imgarray_scale,
                              shift = c(100,20))
```
